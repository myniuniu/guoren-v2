import {
  ...
  listSceneTemplates,
  listScenes,
  removeSceneMenuCategory,
  removeScene,
  removeSceneTemplate,
  saveScene,
  saveSceneMenuCategory,
  saveSceneTemplate,
  seedSceneData,
...
export const sceneApi = {
  ...
  listSceneMenuGroups: async () => listSceneMenuGroups(),
  ...
  saveSceneMenuCategory: async (category) => saveSceneMenuCategory(category),
  removeSceneMenuCategory: async (menuKey) => removeSceneMenuCategory(menuKey),

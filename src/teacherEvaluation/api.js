import {
  ...
  deleteTeacherEvaluationScheme,
  appendTeacherEvaluationEvidence,
  ...
  listTeacherEvaluationTeacherProfiles,
...
export const teacherEvaluationApi = {
  ...
  listTeachers: async () => listTeacherEvaluationTeacherProfiles(),
  saveScheme: async (payload) => saveTeacherEvaluationScheme(payload),
  deleteScheme: async (schemeId, payload) => deleteTeacherEvaluationScheme(schemeId, payload),
  ...
  appendEvidence: async (recordId, payload) => appendTeacherEvaluationEvidence(recordId, payload),
